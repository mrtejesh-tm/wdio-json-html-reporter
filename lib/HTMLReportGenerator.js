...
<head>
  ...
  <style>
    ...
    /* Error cell styles - applies word wrapping and a scrollable area only to error cells */
    .error-cell {
      max-height: 150px;
      overflow-y: auto;
      white-space: normal;
...
<body>
  ...
  <div class="container">
    ...
    <div id="Dashboard" class="tabcontent" style="display: block;">
      ...
      <!-- Pass/Fail Percentages and Chart, centered together -->
  ...
  <script>
    ...
    // Export Test Details table to an Excel file with full HTML formatting but omit the screenshot column.
    ...
    // Toggle display of stack trace on error message click
